...
class NoiseEstimator:
    ...
    def stutter_output(self, stutter_model_out_file):
        ...
        locus_stutter = (
            ...
            f"{self.other_params['total_unfiltered_depth']}\t"  # 40 XXX: total_unfiltered_depth means the total depth of all samples and we don't filter out any reads for this parameter
